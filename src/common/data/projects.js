const projects = [
  {
    ...
    files: [
      { name: "Ace Batting Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Ace Batting Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Ace Batting Logo.Zip", size: "2.02 MB", link: "#" },
