...
const Roles = () => {
    ...
    // const handleChange1 = (e) => {
    //     const updatedRoles = { ...roles, [e.target.name]: e.target.checked };
    ...
    const getbyidrole = () => {
        ...
        axios.post(URL.getbyidrole, params, {
            headers: { Authorization: `Bearer ${token}` }
        }).then((res) => {
            console.log(res.data)
            setform(res.data.roleResult)
            setroles(res.data.roleResult.permissions[0])
        })
    }
    ...
    const Addrole = () => {
        ...
        axios.put(URL.editRole + "/" + roleid, params,
            {
                headers: { Authorization: `Bearer ${token}` }
            }
        )
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container>
                    <Breadcrumbs title="Ace Batting" breadcrumbItem="Edit Roles" />
