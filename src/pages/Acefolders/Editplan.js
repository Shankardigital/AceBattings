...
const Editplans = () => {
    ...
    const getPlansid = () => {
        ...
        var token = datas;
        axios.post(URL.getById, params, {
            headers: { Authorization: `Bearer ${token}` }
        }).then((res) => {
            console.log(res.data.planResult.whatsIncluded)
            setForm(res.data.planResult)
            setInputList(res.data.planResult.whatsIncluded)
    ...
    const Addplans = () => {
        ...
        if (form.type === "Team_subcription" || form.type === "Membership") {
            dataArray.append("gameType", "-")
        } else {
            dataArray.append("gameType", form.gameType)
        }
        dataArray.append("stage", form.stage)
        ...
        axios.post(URL.updateplan + "/" + plansid, dataArray,
            {
                headers: { Authorization: `Bearer ${token}` }
            },
        ).then((res) => {
        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Ace Batting" breadcrumbItem="Edit Plan" />
                    <Row>
                        <Col>
                            <Card className="p-4">
                                <Form onSubmit={(e) => { formsubmit(e) }}>
                                    ...
                                    <Row>
                                        <Col md="4" className="mt-2">
                                            ...
                                            <Input value={form.name} onChange={(e) => { handleChange(e) }} name="name" required type="text" placeholder="Enter Name" />
                                        </Col>
                                        <Col md="4" className="mt-2">
                                            ...
                                            <>
                                                ...
                                                <Col md="4" className="mt-2">
                                                    ...
                                                    required
                                                        ...
                                                        name="stage" value={form.stage} className="form-select">
                                                        <option value="">Select</option>
                                        ...
                                        <Col md="4" className="mt-2">
                                            ...
                                            <Input  value={form.price} onChange={(e) => { handleChange(e) }} name="price" required type="text" placeholder="Enter Price" />
                                        </Col>
                                        <Col md="4" className="mt-2">
                                            <Label>Ball Credits</Label> <span className="text-danger">*</span>
                                            <Input value={form.ballCredits} onChange={(e) => { handleChange(e) }} name="ballCredits" required type="text" placeholder="Enter Ball" />
                                        </Col>
                                        <Col md="4" className="mt-2">
                                        ...
                                        <Col md="4" className="mt-2">
                                            ...
                                            <Input value={form.tax} onChange={(e) => { handleChange(e) }} name="tax" required type="number" placeholder="Enter Tax" />
                                        </Col>
                                        <Col md="4" className="mt-2">
                                        ...
                                        <Col md="4" className="mt-2">
                                            ...
                                            <select className="form-select" value={form.status} onChange={(e) => { handleChange(e) }} name="status" required >
